...
ALTER TABLE "public"."crossView" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."participateView" AS
 SELECT "crossView"."optionId",
    "crossView"."mbti",
    "crossView"."postId",
    "count"("participates"."id") AS "count"
   FROM ("public"."crossView"
     LEFT JOIN "public"."participates" ON ((("crossView"."optionId" = "participates"."optionId") AND (("crossView"."mbti")::"text" = "participates"."userMbti"))))
  GROUP BY "crossView"."optionId", "crossView"."mbti", "crossView"."postId";
...
GRANT ALL ON TABLE "public"."crossView" TO "anon";
GRANT ALL ON TABLE "public"."crossView" TO "authenticated";
GRANT ALL ON TABLE "public"."crossView" TO "service_role";
